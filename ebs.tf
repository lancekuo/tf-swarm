...
resource "null_resource" "ebs_trigger" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            "echo '====== Creating Partition =====';if [ ! -b ${var.partition_file} ]; then sudo parted ${var.device_file} --script -- mklabel msdos mkpart primary ext4 0% 100%;else echo '=> Partition has created, skipping this step...';fi",
